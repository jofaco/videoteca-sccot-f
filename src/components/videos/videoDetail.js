    ...
    return (
        <Container>
            ...
            <div className="iframe1">            
                <iframe  title={video.title_espanol}  src= {video.url_esp} width="100%" height="100%" frameBorder="0" allow="autoplay; fullscreen; " allowFullScreen className="styleIframe"></iframe>
            </div>
